...
const Footer = () => {
  return (
    <footer className="w-full px-20 bg-brand-foreground text-brand-white">
      <div className="grid grid-cols-[3fr_1fr_1fr] gap-16 py-10 mb-16">
        <div className="">
          <p className="text-5xl uppercase font-mak mb-8">muara enim</p>
          <p>Alamat : jalan xxxx</p>
          <p>Telephone : xxx-xxxx-xxxx</p>
          <p>Email : example@gmail.com</p>
        </div>
        <div className="justify-self-end">
          <p className="uppercase font-semibold opacity-50 mb-4">navigations</p>
